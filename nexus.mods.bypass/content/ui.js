...
(function () {
  ...
  */
  ...
  const SETTINGS_UI = [
    ...
    { key: 'HideDownloadBar', label: () => NXTK.t('setHideDownloadBarLabel', null, 'Hide the browser download bar'), type: 'bool', desc: () => NXTK.t('setHideDownloadBarDesc', null, 'Stop the download bar and progress flyout from appearing. This applies to every download in this browser profile, not only Nexus ones. Turn it off to get the bar back; your downloads are always in Ctrl+J.') },
