...
const UIHelpers = {
  ...
  _ALLOWED_IMAGE_HOSTS: ["s4.anilist.co", "myanimelist.net", "media.kitsu.app", "img1.ak.crunchyroll.com", "image.tmdb.org", "an1me.to"],
  ...
  sanitizeImageUrl(url) {
    ...
    try {
      ...
      const allowed = this._ALLOWED_IMAGE_HOSTS.some((h) => host === h || host.endsWith("." + h));
  ...
  createIcon(name) {
    const icons = {
      episodes:
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="2.5" y="2.5" width="19" height="19" rx="5"/><line x1="8" y1="2.5" x2="8" y2="21.5"/><line x1="16" y1="2.5" x2="16" y2="21.5"/><line x1="2.5" y1="12" x2="21.5" y2="12"/></svg>',
      ...
      calendar:
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="16" rx="4"/><path d="M3 10h18"/><path d="M8 3v4M16 3v4"/></svg>',
      delete:
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><line x1="17" y1="7" x2="7" y2="17"/><line x1="7" y1="7" x2="17" y2="17"/></svg>',
      chevron:
      ...
      check:
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><polyline points="8 12 11 15 16 9"/></svg>',
      pause:
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><line x1="10" y1="9" x2="10" y2="15"/><line x1="14" y1="9" x2="14" y2="15"/></svg>',
      ...
      watching:
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M2.5 12S6 5.5 12 5.5 21.5 12 21.5 12 18 18.5 12 18.5 2.5 12 2.5 12z"/><circle cx="12" cy="12" r="2.75"/></svg>',
    ...
    try {
      ...
      el.__atToastLeaveTimer = setTimeout(
        () => {
          ...
          el.__atToastRemoveTimer = setTimeout(() => {
            try {
              el.remove();
            } catch {}
          }, 220);
