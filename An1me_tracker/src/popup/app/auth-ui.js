// auth-ui.js — sign-in UI: Google, email/password, and password reset.
(function () {
  "use strict";
  ...
  const EMAIL_AUTH_ERRORS = {
    ...
    OPERATION_NOT_ALLOWED:
      "Email/password sign-in is not enabled for this project. Enable it in Firebase Console → Authentication → Sign-in methods.",
  ...
  async function handleEmailAuth({ mode }) {
    ...
    if (!email) {
      setEmailFormError(EMAIL_AUTH_ERRORS.MISSING_EMAIL);
      return;
    }
