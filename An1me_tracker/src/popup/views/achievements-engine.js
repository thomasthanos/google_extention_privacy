// achievements-engine.js — achievements/badges logic: which are unlocked and when.
(function () {
  "use strict";
  ...
  function countMovies(animeData) {
    ...
    for (const slug in animeData || {}) {
      ...
      if (!a || !window.AnimeTracker?.SeasonGrouping?.isMovieDisplay?.(slug, a)) continue;
      const hasWatchedEpisode = Array.isArray(a.episodes) && a.episodes.some((episode) => episode?.durationSource !== "anilist");
      if (hasWatchedEpisode || window.AnimeTracker?.StatusService?.isCompleted?.(slug, a)) count++;
    }
    return count;
  }
  ...
  function longestEpisodesInOneSeries(animeData, options) {
    ...
    for (const slug in animeData || {}) {
      ...
      if (onlyCompleted) {
        const isCompleted = window.AnimeTracker?.StatusService?.isCompleted?.(slug, a) || false;
      ...
      if (watchedEpisodes > best) best = watchedEpisodes;
    }
  ...
  function hasComebackGap(animeData, gapDays) {
    ...
    let found = false;
    outer: for (const slug in animeData || {}) {
      if (!Object.prototype.hasOwnProperty.call(animeData, slug)) continue;
      const a = animeData[slug];
  ...
  const BADGE_DEFS = [
    ...
    },
    {
      id: "completionist_25",
      group: "series",
      title: "Series Veteran",
      desc: "Finish 60 series",
      svg: "crown",
      tier: "gold",
      progress: (ctx) => {
        const rows = ctx.categorize();
    ...
    {
      id: "library_builder_75",
      group: "series",
      title: "Archive Curator",
      desc: "Track 150 anime",
      svg: "books",
      tier: "gold",
      progress: (ctx) => ({ current: Math.min(ctx.index.totals.animes, 150), target: 150 }),
    },
    {
      id: "library_builder_100",
      group: "series",
      title: "Archive Architect",
      desc: "Track 300 anime",
      svg: "books",
      tier: "platinum",
    ...
    },
    {
      ...
      group: "series",
      title: "Short Runner",
      desc: "Finish a 100+ episode series",
      svg: "runner",
      tier: "bronze",
    ...
    },
    {
      ...
      group: "series",
      title: "Season Runner",
      desc: "Finish a 250+ episode series",
      svg: "runner",
      tier: "silver",
    ...
    },
    {
      ...
      group: "series",
      title: "Long Runner",
      desc: "Finish a 500+ episode series",
      svg: "runner",
      tier: "gold",
    ...
    },
    {
      ...
      group: "series",
      title: "Epic Finisher",
      desc: "Finish a 1,000+ episode series",
      svg: "sword",
      tier: "platinum",
    ...
    },
    {
      ...
      group: "streaks",
      title: "Marathon Day",
      desc: "Watch 15 episodes in a single day",
      svg: "flame",
      tier: "silver",
    ...
    },
    {
      ...
      desc: "Watch 25 episodes in a single day",
      svg: "rocket",
      tier: "gold",
    ...
    },
    {
      ...
      group: "streaks",
      title: "Legendary Day",
      desc: "Watch 35 episodes in a single day",
      svg: "trophy",
      tier: "platinum",
...

    {
      ...
      group: "lifestyle",
      title: "Night Owl",
      desc: "Watch 5 episodes between 2am and 5am",
      svg: "moon",
      tier: "bronze",
    ...
    },
    {
      ...
      group: "lifestyle",
      title: "Early Bird",
      desc: "Watch 5 episodes between 4am and 7am",
      svg: "sun",
      tier: "bronze",
    ...
    },
    {
      id: "night_owl_5",
      group: "lifestyle",
      title: "Moonlit Watcher",
      desc: "Watch 25 episodes between 2am and 5am",
      svg: "moon",
      tier: "silver",
    ...
    },
    {
      id: "night_owl_20",
      group: "lifestyle",
      title: "Midnight Regular",
      desc: "Watch 75 episodes between 2am and 5am",
      svg: "moon",
      tier: "gold",
    ...
    },
    {
      id: "night_owl_50",
      group: "lifestyle",
      title: "Nocturnal Legend",
      desc: "Watch 150 episodes between 2am and 5am",
      svg: "moon",
      tier: "platinum",
    ...
    },
    {
      ...
      desc: "Watch 25 episodes between 4am and 7am",
      svg: "sun",
      tier: "silver",
    ...
    },
    {
      id: "early_bird_20",
      group: "lifestyle",
      title: "Sunrise Regular",
      desc: "Watch 75 episodes between 4am and 7am",
      svg: "sun",
      tier: "gold",
    ...
    },
    {
      ...
      group: "lifestyle",
      title: "Dawn Legend",
      desc: "Watch 150 episodes between 4am and 7am",
      svg: "sun",
      tier: "platinum",
    ...
    },
    {
      ...
      group: "lifestyle",
      title: "Weekend Mood",
      desc: "Watch 20 episodes on weekends",
      svg: "couch",
      tier: "bronze",
    ...
    },
    {
      ...
      desc: "Watch 75 episodes on weekends",
      svg: "couch",
      tier: "silver",
    ...
    },
    {
      ...
      desc: "Watch 150 episodes on weekends",
      svg: "couch",
      tier: "gold",
    ...
    },
    {
      ...
      desc: "Watch 300 episodes on weekends",
      svg: "couch",
      tier: "platinum",
    ...
    },
    {
      id: "steady_companion",
      group: "lifestyle",
      title: "Steady Companion",
      desc: "Watch one anime across 7+ days",
      svg: "sakura",
      tier: "bronze",
      progress: (ctx) => ({ current: Math.min(longestSpanDays(ctx.index), 7), target: 7 }),
    },
    {
      id: "seasoned_companion",
      group: "lifestyle",
      title: "Seasoned Companion",
      desc: "Watch one anime across 30+ days",
      svg: "sakura",
      tier: "silver",
    ...
    },
    {
      ...
      desc: "Watch one anime across 90+ days",
      svg: "sakura",
      tier: "gold",
      progress: (ctx) => ({ current: Math.min(longestSpanDays(ctx.index), 90), target: 90 }),
    },
    {
      id: "yearlong_companion",
      group: "lifestyle",
      title: "Long-haul Companion",
      desc: "Watch one anime across 180+ days",
      svg: "sakura",
      tier: "platinum",
    ...
    },
    {
      ...
      group: "lifestyle",
      title: "Comeback Kid",
      desc: "Return to a series after 30+ days",
      svg: "loop",
      tier: "bronze",
    ...
    },
    {
      ...
      group: "lifestyle",
      title: "Long Return",
      desc: "Return to a series after 90+ days",
      svg: "loop",
      tier: "silver",
    ...
    },
    {
      ...
      group: "lifestyle",
      title: "Long Comeback",
      desc: "Return to a series after 180+ days",
      svg: "loop",
      tier: "gold",
    ...
    },
    {
      ...
      desc: "Return to a series after 365+ days",
      svg: "loop",
      tier: "platinum",
    ...
    },
    {
      id: "shelf_archivist",
      group: "lifestyle",
      title: "Shelf Archivist",
      desc: "Put 12 anime on hold",
      svg: "books",
      tier: "gold",
  ...
  function evaluateBadges(animeData, index, hourIndex, options) {
    ...
    let unlocksKey = "";
    try {
      unlocksKey = JSON.stringify(existingUnlocks);
    } catch {
      unlocksKey = String(Date.now());
    }
    if (_badgeCache && _badgeCache.index === index && _badgeCache.hourIndex === hourIndex && _badgeCache.unlocksKey === unlocksKey) {
    ...
    const result = BADGE_DEFS.map((def) => {
      ...
      const achievedNow = progress.current >= progress.target;
      const unlocked = achievedNow || !!stored;
      return {
        id: def.id,
        ...
        justUnlocked: achievedNow && !stored,
      };
    });
  ...
  function analyzeGoalContext(animeData) {
    ...
    for (const slug in animeData || {}) {
      ...
      const status = window.AnimeTracker?.StatusService?.getStatus?.(slug, anime) || null;
      if (status === "dropped") summary.dropped++;
      else if (status === "on_hold") summary.onHold++;
  ...
  function analyzeUpcomingReleases(animeData, now = Date.now()) {
    ...
    const anilist = typeof window !== "undefined" ? window.AnimeTracker?.AnilistService : null;
    ...
    for (const slug in animeData) {
      ...
      if (anime.droppedAt || anime.completedAt || anime.onHoldAt || ["dropped", "completed", "on_hold"].includes(listState)) continue;
  ...
  function buildSmartGoalsSummary(context, profile, autoAdjusted, releases) {
    ...
    return autoAdjusted > 0 ? `Smart goals updated automatically from ${parts.join(", ")}.` : `Smart goals adapt from ${parts.join(", ")}.`;
  }
  ...
  function buildSmartGoalPlan(animeData, index, goalSettings) {
    ...
    const avgEpisodeMinutes =
      (Number(index?.totals?.episodes) || 0) > 0
    ...
    if ((recent30.episodes || weeklyEpisodes) > 0) {
      ...
      if (monthlySupply > 0) {
        const pullStrength = 0.18 + clampNumber(consistency, 0, 1) * 0.3; // 0.18..0.48
    ...
    if (!Number.isFinite(monthlyEpisodes) || monthlyEpisodes <= 0)
      monthlyEpisodes = Math.max(defaults.monthly.targetEpisodes, weeklyEpisodes * 4);
    ...
    const suggestions = {
      daily: {
        ...
        note: hasWatchHistory
          ? buildSmartGoalNote("daily", context, profile, windows, releases)
          : "Auto: starter default until you build watch history",
      },
      weekly: {
        ...
        note: hasWatchHistory
          ? buildSmartGoalNote("weekly", context, profile, windows, releases)
          : "Auto: starter default until your pace is clearer",
      },
      monthly: {
        field: "targetEpisodes",
        ...
        note: hasWatchHistory
          ? buildSmartGoalNote("monthly", context, profile, windows, releases)
          : "Auto: starter default until your library flow is clearer",
      },
    };
    ...
    for (const key of Object.keys(suggestions)) {
      ...
      const canAutoApply = entry.smartManaged !== false && (justLearned || (targetChanged && cooldownPassed));
      ...
      suggestion.status = justLearned ? "bias-learned" : targetChanged ? "suggested" : "aligned";
  ...
  function resetDerivedCaches() {
    _badgeCache = null;
    _hcCountDropped.animeData = null;
    _hcCountDropped.value = 0;
    _hcCountOnHold.animeData = null;
    _hcCountOnHold.value = 0;
    _hcLongestEpsRef = null;
    _hcLongestEps.clear();
    _hcWeekendEps.animeData = null;
    _hcWeekendEps.value = 0;
    _hcComebackGapRef = null;
    _hcComebackGap.clear();
    _hcMaxComebackGap.animeData = null;
    _hcMaxComebackGap.value = 0;
  }
  ...
  const GoalEngine = Object.freeze({
    evaluateGoals,
    buildSmartGoalPlan,
  ...
  window.AnimeTracker.BadgeEngine = BadgeEngine;
  window.AnimeTracker.GoalEngine = GoalEngine;
})();
